...
def main(args):
    ...
    for epoch in range(N_EPOCHS):
        ...
        logger.info(f"model size: {mixprec_model.get_size().item()}")
    ...
    model.eval()
    logger.info("model size: {}".format(mixprec_model.get_regularization_loss().item()))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pit_checkpoint', type=str, help='Path to the PIT folder to load')
